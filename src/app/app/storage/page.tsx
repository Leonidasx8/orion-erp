      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex w-full items-center justify-center">
            <label
              className={`flex w-full cursor-pointer flex-col items-center rounded-lg border-2 bg-white px-4 py-6 tracking-wide shadow-lg transition-colors ${
                isDragging
            ...
            <DialogContent>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="relative rounded-full p-2 text-primary-600 transition-colors hover:bg-primary-50"
                >
