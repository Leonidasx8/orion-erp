...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 transform border-t bg-white shadow-lg transition-transform duration-500 ease-in-out">
          ...
          <div className="flex flex-shrink-0 items-center gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-500">
                ...
                and{' '}
                <Link href={`/legal/terms`} className="text-blue-600 underline hover:text-blue-700">
                  Terms of Service
                </Link>{' '}
